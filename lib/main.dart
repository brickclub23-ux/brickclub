                        ...
                        children: [
                          ...
                          Center(
                            child: TextButton.icon(
                              ...
                              onPressed: () =>
                                  setState(() => adminAccess = !adminAccess),
                              icon: Icon(
                                adminAccess
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        for (final field in const [
                          ('First name', 'Joshua', false),
                          ('Last name', 'Awule', false),
                          ('Email', 'joshua@brickclub.ug', false),
                          ('Password', 'password10', true),
                          ('Confirm password', 'password10', true),
                        ]) ...[
                          FieldLabel(field.$1),
                  ...
                  PrimaryButton(
                    ...
                    onPressed: accepted ? widget.onCreated : null,
                  ),
                  const SizedBox(height: 10),
                  const Text(
